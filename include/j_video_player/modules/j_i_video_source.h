...
#ifndef FFMPEG_VIDEO_PLAYER_J_I_VIDEO_SOURCE_H
#define FFMPEG_VIDEO_PLAYER_J_I_VIDEO_SOURCE_H
...
public:
  ...
  virtual VideoSourceState getState() = 0;
...
#endif // FFMPEG_VIDEO_PLAYER_J_I_VIDEO_SOURCE_H
